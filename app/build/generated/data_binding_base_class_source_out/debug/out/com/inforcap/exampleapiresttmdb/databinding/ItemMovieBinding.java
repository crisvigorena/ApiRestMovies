...
public final class ItemMovieBinding implements ViewBinding {
  ...
  private ItemMovieBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cvMovie,
      @NonNull AppCompatImageView ivImage, @NonNull TextView tvInfo) {
  ...
  public static ItemMovieBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.cvMovie;
      CardView cvMovie = ViewBindings.findChildViewById(rootView, id);
      if (cvMovie == null) {
        break missingId;
      }
      ...
      return new ItemMovieBinding((ConstraintLayout) rootView, cvMovie, ivImage, tvInfo);
    }
